...
const leaders = [
  {
    ...
    bio: "Evan. Kwadwo Abeagye-Asare leads All Believers Chapel with a passionate heart for discipleship and community transformation. He has dedicated decades of ministry to equipping believers in Leeds and beyond.",
